...
const styles = StyleSheet.create({
  ...
  datePlaceholder: { color: colors.textMuted, fontFamily: 'Inter-Regular', fontSize: 14 },
  dateValue: { color: colors.textPrimary, fontFamily: 'Inter-Regular', fontSize: 14 },
  ...
  label: { color: colors.textSecondary, fontFamily: 'Inter-Regular', fontSize: 12, marginTop: 14 },
  pickerActions: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    paddingHorizontal: 16,
  ...
  pickerClear: { color: colors.error, fontFamily: 'Inter-Regular', fontSize: 14 },
  pickerContainer: {
    backgroundColor: colors.surfaceUp,
    borderColor: colors.border,
    borderRadius: 10,
  ...
  pickerDone: { color: colors.amber, fontFamily: 'Inter-Regular', fontSize: 14 },
  saveBtn: {
  ...
  saveBtnText: { color: colors.bg, fontFamily: 'Inter-Regular', fontSize: 13 },
  sectionHeader: {
  ...
  switchHint: { color: colors.textMuted, fontFamily: 'Inter-Regular', fontSize: 11, marginTop: 2 },
  switchRow: {
    alignItems: 'center',
    flexDirection: 'row',
    justifyContent: 'space-between',
