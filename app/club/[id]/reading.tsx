...
const styles = StyleSheet.create({
  ...
  advanceText: { color: colors.amber, fontFamily: 'SpaceMono', fontSize: 11 },
  authorName: { color: colors.textSecondary, flex: 1, fontFamily: 'SpaceMono', fontSize: 12 },
  avatar: {
    alignItems: 'center',
  ...
  chapterLabel: { color: colors.textPrimary, fontFamily: 'Georgia', fontSize: 18 },
  container: { backgroundColor: colors.bg, flex: 1 },
  content: { color: colors.textPrimary, fontFamily: 'Georgia', fontSize: 15, lineHeight: 22 },
  emptyComments: { alignItems: 'center', gap: 6, paddingTop: 60 },
  emptyHint: { color: colors.textMuted, fontFamily: 'SpaceMono', fontSize: 11 },
  ...
  pageLabel: { color: colors.textMuted, fontFamily: 'SpaceMono', fontSize: 12, marginTop: 2 },
  progressBadge: {
    alignItems: 'center',
  ...
  progressBadgeText: { color: colors.success, fontFamily: 'SpaceMono', fontSize: 10 },
  progressBanner: {
    alignItems: 'center',
    borderBottomColor: colors.border,
    borderBottomWidth: 1,
  ...
  spoilerToggleActive: {},
  spoilerToggleText: { color: colors.textMuted, fontFamily: 'SpaceMono', fontSize: 11 },
