...
const styles = StyleSheet.create({
  ...
  cardAuthor: { color: colors.textSecondary, fontFamily: 'SpaceMono', fontSize: 11 },
  ...
  tabBadgeText: { color: colors.amber, fontFamily: 'SpaceMono', fontSize: 9 },
  tabText: { color: colors.textMuted, fontFamily: 'SpaceMono', fontSize: 11 },
