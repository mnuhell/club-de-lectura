...
const styles = StyleSheet.create({
  ...
  hintText: { color: colors.textMuted, fontFamily: 'Inter-Regular', fontSize: 14 },
  input: {
  ...
  resultAuthor: { color: colors.textSecondary, fontFamily: 'Inter-Regular', fontSize: 12 },
  resultBody: { flex: 1, gap: 3 },
  resultMeta: { color: colors.textMuted, fontFamily: 'Inter-Regular', fontSize: 11 },
  resultTitle: { color: colors.textPrimary, fontFamily: 'Inter-Regular', fontSize: 16 },
  savingOverlay: {
    alignItems: 'center',
  ...
  savingText: { color: colors.textSecondary, fontFamily: 'Inter-Regular', fontSize: 13 },
  scanButton: {
    alignItems: 'center',
    backgroundColor: colors.amberFaint,
    borderRadius: 12,
  ...
  scanHintText: { color: colors.amber, fontFamily: 'Inter-Regular', fontSize: 13 },
  scanner: { flex: 1 },
  scannerClose: {
