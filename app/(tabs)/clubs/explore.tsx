...
const styles = StyleSheet.create({
  ...
  closedText: { color: colors.error, fontFamily: 'Inter-Regular', fontSize: 10 },
  ...
  joinText: { color: colors.bg, fontFamily: 'Inter-Regular', fontSize: 12, textAlign: 'center' },
  ...
  memberText: { color: colors.amber, fontFamily: 'Inter-Regular', fontSize: 11 },
  metaItem: { alignItems: 'center', flexDirection: 'row', gap: 4 },
  metaText: { color: colors.textMuted, fontFamily: 'Inter-Regular', fontSize: 11 },
  retryBtn: {
    borderColor: colors.border,
    borderRadius: 8,
    borderWidth: 1,
  ...
  title: { color: colors.textPrimary, fontFamily: 'Inter-Regular', fontSize: 22 },
})
