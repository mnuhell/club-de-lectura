...
const styles = StyleSheet.create({
  ...
  dateIcon: { fontSize: 17 },
  datePlaceholder: { color: colors.textMuted, fontFamily: 'Inter-Regular', fontSize: 16 },
  dateValue: { color: colors.textPrimary, fontFamily: 'Inter-Regular', fontSize: 16 },
  ...
  pickerClear: { color: colors.textMuted, fontFamily: 'Inter-Regular', fontSize: 14 },
  pickerContainer: {
    backgroundColor: colors.surfaceUp,
    borderColor: colors.border,
    borderRadius: 10,
