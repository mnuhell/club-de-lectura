...
const styles = StyleSheet.create({
  ...
  removeBtnText: { color: colors.textMuted, fontSize: 17 },
  resultAuthor: { color: colors.textSecondary, fontFamily: 'Inter-Regular', fontSize: 11 },
  ...
  resultTitle: { color: colors.textPrimary, fontFamily: 'Inter-Regular', fontSize: 14 },
  results: {
    backgroundColor: colors.surfaceUp,
    borderColor: colors.border,
    borderRadius: 10,
  ...
  selectedAuthor: { color: colors.textSecondary, fontFamily: 'Inter-Regular', fontSize: 12 },
  ...
  selectedTitle: { color: colors.textPrimary, fontFamily: 'Inter-Regular', fontSize: 15 },
